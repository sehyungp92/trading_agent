"""Downturn phased auto-optimization CLI."""
...
ROUND_MANAGER = RoundManager("momentum", "downturn")
...
def cmd_phase_auto(args: argparse.Namespace) -> None:
    ...
    print("Downturn auto-optimization complete.")
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="downturn-auto", description="Downturn phased auto-optimization")
    ...
    phase_run = sub.add_parser("phase-run", help="Run a single downturn phase")
    ...
    phase_auto = sub.add_parser("phase-auto", help="Run all downturn phases")
