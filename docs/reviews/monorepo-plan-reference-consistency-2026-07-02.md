# Consistency Check: implementation plan vs `_references/` codebases
...
### Crypto (`_references/crypto_trader`)
...
### K-stock (`_references/k_stock_trader`)
...
### Assistant (`_references/trading_assistant_agent`)
