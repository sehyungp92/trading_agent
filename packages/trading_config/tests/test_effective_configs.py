...
def test_generate_and_verify_effective_configs(tmp_path: Path) -> None:
    for relative in (
        "trading/ibkr_trader/config/strategies.yaml",
        "trading/ibkr_trader/config/portfolio.yaml",
        "trading/crypto_trader/config/live_config.example.json",
        "trading/crypto_trader/config/strategies",
        "trading/k_stock_trader/config/kalcb.yaml",
        "trading/k_stock_trader/config/optimization",
        "trading/k_stock_trader/config/olr_kalcb/olr_deployment_universe_103.yaml",
        "trading/k_stock_trader/strategy_kalcb/config.py",
